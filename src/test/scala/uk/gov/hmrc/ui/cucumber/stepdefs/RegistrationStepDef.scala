...
//import uk.gov.hmrc.ui.pages.CommonPage._
//import uk.gov.hmrc.ui.pages.CommonPage
//import uk.gov.hmrc.ui.pages.RegistrationPage._
//
...
//    Assert.assertTrue(htmlBody.contains("Countries registered in Cyprus"))
...
//    Assert.assertTrue(htmlBody.contains("Countries registered in changed Cyprus"))
